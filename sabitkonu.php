...
<html lang="en-US">
	<head>
		<base href="<?=$site_url?>"  />
		<?=$site->head("Bilgilendirme / Faydalı Bilgiler");?>
	...
	<body>
		...
		<div class="container">
			<div class="edc col-md-8">
				...
				<?php
					$users_posts = tabloCek("users_posts", "*", "WHERE version = '2' ORDER BY id DESC");
					...
					$users_posts = tabloCek("users_posts", "*", "WHERE version = '2' ORDER BY id DESC LIMIT {$limit}, {$goruntulenecekToplamItem}");
