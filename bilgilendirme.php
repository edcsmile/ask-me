	...
	<body>
		...
		<div class="container">
			<div class="edc col-md-8">
				...
				<?php
					$users_posts = tabloCek("users_posts", "*", "WHERE version = '1' ORDER BY id DESC");
					...
					$users_posts = tabloCek("users_posts", "*", "WHERE version = '1' ORDER BY id DESC LIMIT {$limit}, {$goruntulenecekToplamItem}");
